...
API_ID = int(environ.get('API_ID', '20937420'))  # Telegram API ID
API_HASH = environ.get('API_HASH', '09d7f6744feb17759304df65666961da')  # Telegram API Hash
BOT_TOKEN = environ.get('BOT_TOKEN', '8304535177:AAFzhBtmUvl4O0fvBEXwPyLzR1WCZrhx1cU')  # Telegram Bot Token

# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003198126007'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002908124049'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002908124049'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002908124049'))  # Verified user actions log
...
SUPPORT = environ.get('SUPPORT', 'https://t.me/updatechannal123')  # Support group
...
URL = f"https://web-production-e186f.up.railway.app/"
